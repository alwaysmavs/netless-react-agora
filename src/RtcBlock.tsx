...
import rtc_media from "./images/rtc_media.svg";
...
import rtcBlock from "./RtcBlock.less";
...
export default class RtcBlock extends React.Component<RtcBlockProps, RtcBlockState> {
    ...
    public render(): React.ReactNode {
        ...
        return <RtcBlockContextConsumer children={context => (
            <div
                className={rtcBlock["rtc-block-box"]}
                style={{
    ...
    private renderHiding(): React.ReactNode {
        return (
            <div className={rtcBlock["rtc-float-btn"]}>
                <img src={rtc_media}/>
            </div>
        );
    }
    ...
    private renderFloating(): React.ReactNode {
        return (
            <div className={rtcBlock["rtc-float-box-preview"]}>
                <div className={rtcBlock["rtc-float-media-icon"]}>
                    <img onDragStart={event => event.preventDefault()} src={rtc_media}/>
                </div>
                <div className={rtcBlock["rtc-float-box-preview-inf"]}>calling</div>
            </div>
        );
    }
